...
export default function ChangeModal({ change, mode, onClose, onSave, onDelete }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" data-testid="change-modal-overlay">
      <div className="bg-white rounded-md shadow-xl border-t-4 border-[#1351B4] w-full max-w-3xl max-h-[90vh] overflow-y-auto" data-testid="change-modal">
        {/* Header */}
        <div className="flex items-center justify-between p-6 pb-4 border-b border-[#E6E6E6]">
          ...
          <div className="flex items-center gap-2">
            {mode === 'view' && !editing && (
              <button
                data-testid="change-edit-button"
                onClick={() => setEditing(true)}
                className="flex items-center gap-1 text-sm text-[#1351B4] hover:text-[#071D41] font-semibold transition-colors"
              >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange('numero_rfc', e.target.value)}
                    disabled={isReadonly}
                    className="border-[#E6E6E6]"
                    placeholder="Ex: RFC-2026-0001"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleChange('tipo_mudanca', e.target.value)}
                    disabled={isReadonly}
                    className={selectClass}
                  >
                    {TIPO_MUDANCA_OPTIONS.map(opt => (
              ...
              <div>
                ...
                <textarea
                  data-testid="change-justificativa-input"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleChange('categoria_itil', e.target.value)}
                  disabled={isReadonly}
                  className={selectClass}
                >
                  {CATEGORIA_ITIL_OPTIONS.map(opt => (
                    <option key={opt.value} value={opt.value}>{opt.label}</option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  data-testid="change-prioridade-select"
              ...
              <div>
                ...
                <select
                  data-testid="change-risco-select"
                  value={form.risco}
            ...
            <div className="mt-4">
              ...
              <select
                data-testid="change-impacto-select"
                value={form.impacto}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    data-testid="change-data-fim-input"
                    type="date"
                    value={form.data_fim}
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.plano_rollback}
                  onChange={(e) => handleChange('plano_rollback', e.target.value)}
                  disabled={isReadonly}
                  rows={2}
                  className={textareaClass}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    data-testid="change-aprovador-input"
                    value={form.aprovador}
                    onChange={(e) => handleChange('aprovador', e.target.value)}
                    disabled={isReadonly}
                    className="border-[#E6E6E6]"
                    placeholder="Nome do aprovador (CAB)"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    data-testid="change-sistema-input"
                    value={form.sistema_afetado}
                    onChange={(e) => handleChange('sistema_afetado', e.target.value)}
                    disabled={isReadonly}
                    className="border-[#E6E6E6]"
                    placeholder="Sistema principal impactado"
                  />
                </div>
                <div>
          ...
          {isReadonly && change && (
            <div className="bg-[#f8f8f8] rounded-md p-4 text-xs text-[#555555] space-y-2 border border-[#E6E6E6]">
              ...
              <div className="flex items-center gap-3 mt-2 pt-2 border-t border-[#E6E6E6]">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-[#E6E6E6]">
              <div>
                {mode === 'view' && editing && onDelete && (
                  <button
                    data-testid="change-delete-button"
                    type="button"
                    onClick={() => onDelete(change.id)}
                    className="flex items-center gap-1 bg-[#E52207] hover:bg-[#8A100B] text-white rounded-full px-4 py-2 text-sm font-semibold transition-colors"
                  >
              ...
              <div className="flex items-center gap-3">
                <button
                  data-testid="change-cancel-button"
                  type="button"
                  onClick={onClose}
                  className="bg-transparent border-2 border-[#1351B4] text-[#1351B4] hover:bg-[#1351B4]/10 rounded-full px-6 py-2 text-sm font-semibold transition-colors"
                >
                  Cancelar
                </button>
                <button
                  data-testid="change-save-button"
                  type="submit"
                  className="flex items-center gap-1 bg-[#1351B4] hover:bg-[#071D41] text-white rounded-full px-6 py-2 text-sm font-semibold transition-colors"
                >
