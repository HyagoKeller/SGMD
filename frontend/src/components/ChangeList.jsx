...
import { Clock, ArrowRight, HardDrive, Monitor, AlertTriangle } from 'lucide-react';
import SuperSapiensIcon from './SuperSapiensIcon';

function FrenteIconList({ frenteKey, className, style }) {
        ...
        return (
          ...
          >
            <div className="w-8 h-8 rounded-md flex items-center justify-center mt-0.5 flex-shrink-0" style={{ backgroundColor: frenteCfg.color }}>
              <FrenteIconList frenteKey={frenteKey} className="w-4 h-4 text-white" />
            </div>
